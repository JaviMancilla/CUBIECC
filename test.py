        ...
        if(punto1.x == 0 and punto1.y == 0):
            ...
            while n_operacion!=1 and n_operacion!=2 and n_operacion!=3 and n_operacion!=4 and n_operacion!=5 and n_operacion!=6:
                ...
                #--------------------------------------------------
                    ...
                    print('\n')
                    persona2 = ECDH_NSS(curva1, punto1, orden)
                    print('LLave privada Persona 2:')
                    print(persona2.llave_privada)
                    print('\n')
                    print('LLave publica Persona 2:')
                    print(persona2.llave_publica.x)
                    print(persona2.llave_publica.y)
                    print('\n')


                    secreto_persona1 = persona1.calcula_secreto_compartido(persona2.llave_publica)
                    print('Secreto persona 1:')
                    print(secreto_persona1.x)
                    print(secreto_persona1.y)
                    print('\n')
                    secreto_persona2 = persona2.calcula_secreto_compartido(persona1.llave_publica)
                    print('Secreto persona 2:')
                    print(secreto_persona2.x)
                    print(secreto_persona2.y)
                    print('\n')
                    if secreto_persona1.x == secreto_persona2.x and secreto_persona1.y == secreto_persona2.y :
                        print('Correcto')
                    else:
                        print('Incorrecto')
                ...
                #--------------------------------------------------
                    ...
                    print('-------------------------------------------')
                    print(' CALCULO ECDSA "Non-Supersingular"')
                    print('-------------------------------------------')
...
#----------------------------------------------------------------------------------------------
            ...
            while n_operacion!=1 and n_operacion!=2 and n_operacion!=3 and n_operacion!=4 and n_operacion!=5 and n_operacion!=6:
                ...
                if n_operacion == 1:
                    ...
                    print('es el Punto -P:')
                    negativo_p.pinta_punto()
                    if (curva1.pertenece_a_NSS(negativo_p) == True):
                        print('PERTENECE  a la ')
                        curva1.pinta_curvaNSS()
                    else:
                        print('NO PERTENECE a la ')
                ...
                #--------------------------------------------------
                    ...
                    if (punto2.x == 0 and punto2.y ==0):
                    ...
                    elif (curva1.pertenece_a_NSS(punto2) == True):
                        punto2.pinta_punto()
                        print('PERTENECE  a la ')
                        curva1.pinta_curvaNSS()
                        print('')
                        ...
                        print('El resultado de la suma de P y Q es:')
                        resultSumaPQ.pinta_punto()
                        if(resultSumaPQ.x == 0 and resultSumaPQ.y == 0):
                            print('Este es el punto infinito de la ...')
                            curva1.pinta_curvaNSS()
                        elif (curva1.pertenece_a_NSS(resultSumaPQ) == True):
                            print('PERTENECE  a la ')
                            curva1.pinta_curvaNSS()
                        else:
                            print('NO PERTENECE a la ')
                ...
                #--------------------------------------------------
                    ...
                    print('Punto de la curva:')
                    punto1.pinta_punto()
                    print('\n')
                    print('Punto duplicado:')
                    punto_duplicado.pinta_punto()
                    print('-------------------------------------------')
                    print('')
                    print('¿EL PUNTO DUPLICADO PERTENECE AL TIPO DE CURVA "Non-Supersingular"?' )
                    if (curva1.pertenece_a_NSS(punto_duplicado) == True):
                        punto_duplicado.pinta_punto()
                        print('PERTENECE  a la ')
                        curva1.pinta_curvaNSS()
                    else:
                ...
                #--------------------------------------------------
                    ...
                    punto_por_k.pinta_punto()
                    print('')
                    if(punto_por_k.x == 0 and punto_por_k.y == 0):
                            punto_por_k.pinta_punto()
                            print('Este es el punto infinito de la ...')
                            curva1.pinta_curvaNSS()
                    elif (curva1.pertenece_a_NSS(punto_por_k) == True):
                        punto_por_k.pinta_punto()
                        print('PERTENECE  a la ')
                        curva1.pinta_curvaNSS()
                    else:
        ...
        if (curva1.pertenece_a_SS(punto1) == True):
            ...
            while n_operacion!=1 and n_operacion!=2 and n_operacion!=3 and n_operacion!=4 and n_operacion!=5 and n_operacion!=6:
                ...
                #--------------------------------------------------
                    ...
                    print('-------------------------------------------')
                    print('PUNTO "P" DUPLICADO "Supersingular"')
                    print('-------------------------------------------')
                    punto_duplicado = curva1.punto_duplicado_SS(punto1)
                    punto_duplicado.pinta_punto()
                    print('-------------------------------------------')
                    print('')
                    print('¿EL PUNTO DUPLICADO PERTENECE AL TIPO DE CURVA "Supersingular"?' )
                    if (curva1.pertenece_a_SS(punto_duplicado) == True):
                        punto_duplicado.pinta_punto()
                        print('PERTENECE  a la ')
                        curva1.pinta_curvaSS()
                    else:
                ...
                #--------------------------------------------------
                    ...
                    print('-------------------------------------------')
                    print('MULTIPLICACION DE UN NUMERO DADO POR EL PUNTO "P" "Supersingular"')
                    print('-------------------------------------------')
                    print(' Escriba el número por el cual multiplicar el PUNTO "P" ')
                    print('---------------------------------------------------')
                    k = int(input('Introduzca el número:'))
                    punto_por_k = curva1.multiplicacion_escalar_SS(k, punto1)
                    punto_por_k.pinta_punto()
                    print('')
                    if(punto_por_k.x == 0 and punto_por_k.y == 0):
                            punto_por_k.pinta_punto()
                            print('Este es el punto infinito de la ...')
                            curva1.pinta_curvaSS()
                    elif (curva1.pertenece_a_SS(punto_por_k) == True):
                        punto_por_k.pinta_punto()
                        print('PERTENECE  a la ')
                        curva1.pinta_curvaSS()
                    else:
                ...
                #--------------------------------------------------
                    ...
                    print('LLave privada Persona 1:', persona1.llave_privada)
                    print('LLave publica Persona 1:', persona1.llave_publica.x, persona1.llave_publica.y)
                    persona2 = ECDH_SS(curva1, punto1, orden)
                    print('LLave privada Persona 2:', persona2.llave_privada)
                    print('LLave publica Persona 2:', persona2.llave_publica.x, persona2.llave_publica.y)


                    secreto_persona1 = persona1.calcula_secreto_compartido(persona2.llave_publica)
                    print('Secreto persona 1:', secreto_persona1.x, secreto_persona1.y)
                    secreto_persona2 = persona2.calcula_secreto_compartido(persona1.llave_publica)
                    print('Secreto persona 2:', secreto_persona2.x, secreto_persona2.y)
                ...
                #--------------------------------------------------
                    ...
                    print(' CALCULO ECDSA "Non-Supersingular"')
                    print('-------------------------------------------')
                    persona1 = ECDSA_SS(curva1, punto1, orden)
                    print('LLave privada Persona 1:', persona1.llave_privada)
                    print('LLave publica Persona 1:', persona1.llave_publica.x, persona1.llave_publica.y)
                    

                    fichero = 'curvasElipticas.md'
                    

                    firma_persona1 = persona1.firma(fichero)
                    print('Firma persona 1:', firma_persona1.x, firma_persona1.y)
                    print('\n')
                    print(' Comprobamos la firma:')
                    print('-------------------------------------------')
